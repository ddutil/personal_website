  ...
  if (loading) {
    return (
      <div className="mt-6 pt-4 border-t border-slate-700/60">
        <p data-testid="github-stats-title" className="text-xs font-semibold uppercase tracking-widest text-violet-400 mb-3">GitHub Stats</p>
  ...
  return (
    <div className="mt-6 pt-4 border-t border-slate-700/60">
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {/* Total Commits */}
        <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-700/50 border border-slate-600/50 rounded-lg text-sm text-slate-300" data-testid="github-total-commits">
        ...
        {/* Recent Commits */}
        <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-700/50 border border-slate-600/50 rounded-lg text-sm text-slate-300" data-testid="github-recent-commits">
        ...
        {/* Last Push */}
        <div className="flex items-center gap-2 px-3 py-1.5 bg-slate-700/50 border border-slate-600/50 rounded-lg text-sm text-slate-300" data-testid="github-last-push">
