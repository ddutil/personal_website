  ...
  return (
    <main className="flex min-h-screen flex-col items-center text-slate-200 px-4 sm:px-6 lg:px-8">
      <div className="text-center mb-10">
        ...
        <h1 data-testid="home-display-name" className="text-violet-300 text-6xl md:text-8xl font-extrabold tracking-tight">
          {displayName}
        </h1>
        <h2 data-testid="home-job-title" className="text-2xl md:text-3xl font-semibold mt-4 tracking-tight">
          {jobTitle}
        </h2>
      </div>
      ...
      <div className="flex flex-col sm:flex-row gap-4 mb-10 w-full sm:w-auto px-6 sm:px-0">
        <a
          ...
          data-testid="home-resume-button"
        >
          Get Resume
        </a>
        <a
          ...
          className={buttonStyle}
          data-testid="home-linkedin-button"
        >
          View LinkedIn
        </a>
        <a
